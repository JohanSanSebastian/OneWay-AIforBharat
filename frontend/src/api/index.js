...
export const sentinelApi = {
  ...
  // Parking Assistant - accepts plate and photo (multipart/form-data)
  parkingAssist: (plateNumber, photoFile) => {
    const form = new FormData()
    form.append('plate_number', plateNumber || '')
    if (photoFile) form.append('photo', photoFile)
    return api.post('/sentinel/parking-assist', form, { headers: { 'Content-Type': 'multipart/form-data' } })
  },
